...
#TODO use config generated by install in backup dir. (generate & source config with variables?)
#TODO backup more directories
( cd $dotBackupDir ; pwd ; .run "${rib} '${HOME}/Programy' '/home/jezek/Zálohy/jEzShiBook/rib' 'jezek@192.168.88.132'" )
