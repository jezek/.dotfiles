#!/bin/sh
#blog: http://javier.io/blog/en/2015/09/30/using-imagemagick-and-kmeans-to-find-dominant-colors-in-images.html
#source: https://github.com/javier-lopez/learn/blob/master/sh/tools/dcolors
...
_kmeans_awk() {
    ...
    function _calculate_center(plist) {
        ...
        if(ccount) {
            sumX=int(sumX/ccount)
            sumY=int(sumY/ccount)
            sumZ=int(sumZ/ccount)
        }
